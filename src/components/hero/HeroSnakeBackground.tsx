...
export default function HeroSnakeBackground() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none', opacity: isVisible ? 1 : 0, transition: 'opacity 0.8s ease-in-out' }}>
      ...
      />
      <div className="absolute bottom-8 right-12 text-sm tracking-widest transition-opacity duration-1000" style={{ color: 'rgba(255, 255, 255, 0.15)', fontFamily: '"Press Start 2P", monospace' }}>
